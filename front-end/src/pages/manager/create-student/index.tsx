...
function CreateStudentPage() {
  ...
  const eventClickAvatar = () => {
    if (thumbnail) {
      thumbnail.click();
    } else {
      console.log("Error in create student button");
    }
  };
  return (
    <>
        ...
        <div className="relative flex flex-col gap-[10px]">
          ...
          <div className="flex items-center gap-[14px]">
            <div id="thumbnail-preview-container" className="relative flex shrink-0 w-20 h-20 rounded-[20px] border border-[#CFDBEF] overflow-hidden">
              <button type="button" id="trigger-input" className="absolute top-0 left-0 w-full h-full flex justify-center items-center gap-3 z-0" onClick={eventClickAvatar}>
