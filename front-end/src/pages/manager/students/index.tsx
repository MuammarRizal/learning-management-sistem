    ...
    <>
        <header className="flex items-center justify-between gap-[30px]">
            ...
            <div className="flex items-center gap-3">
                ...
                <Link to="/manager/students/create-student" className="w-fit rounded-full p-[14px_20px] font-semibold text-[#FFFFFF] bg-[#662FFF] text-nowrap">
                    Add Student
                </Link>
            </div>
        </header>
        <section id="CourseList" className="flex flex-col w-full rounded-[30px] p-[30px] gap-[30px] bg-[#F8FAFB]">
            <StudentCard imageProfile='user.jpg' name='User' courseJoined={5} id={1}/>
