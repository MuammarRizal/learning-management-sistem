...
function SignIn() {
  ...
  return (
    <div className="relative flex flex-col flex-1 p-[10px]">
      ...
      <Navbar />
      <form onSubmit={handleSubmit(onSubmitForm)} className="flex flex-col w-[400px] h-fit rounded-[20px] border border-[#262A56] p-[30px] gap-[30px] bg-[#080A2A] m-auto">
        <div>
        ...
        <div className="relative flex items-center gap-3 w-full rounded-full border p-[14px_20px] transition-all duration-300 focus-within:border-[#8661EE] focus-within:shadow-[-10px_-6px_10px_0_#7F33FF_inset] bg-[#070B24] border-[#24283E] shadow-[-10px_-6px_10px_0_#181A35_inset]">
          ...
          <input type="email" {...register("email")} id="email" className="appearance-none outline-none !bg-transparent w-full font-semibold text-white placeholder:font-normal placeholder:text-[#6B6C7F]" placeholder="Write your email address" />
        ...
        <div>
          <div className="relative flex items-center gap-3 w-full rounded-full border p-[14px_20px] transition-all duration-300 focus-within:border-[#8661EE] focus-within:shadow-[-10px_-6px_10px_0_#7F33FF_inset] bg-[#070B24] border-[#24283E] shadow-[-10px_-6px_10px_0_#181A35_inset]">
            ...
            <input type="password" {...register("password")} id="password" className="appearance-none outline-none !bg-transparent w-full font-semibold text-white placeholder:font-normal placeholder:text-[#6B6C7F]" placeholder="Type your secure password" />
            <p className="text-red-500 text-xs absolute -bottom-5 w-max">{errors.password?.message}</p>
          </div>

          <div className="flex justify-end mt-[25px]">
            <Link to="/reset-password" className="text-sm leading-[21px] text-[#662FFF] hover:underline">
              Forgot Password
            </Link>
          </div>
        </div>
